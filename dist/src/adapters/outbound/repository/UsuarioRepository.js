...
const UsuarioEntity_1 = __importDefault(require("../../inbound/entity/UsuarioEntity"));
class UsuarioRepository {
    // private repository: Repository<UsuarioEntity>;
    constructor() {
        this.salvar = (usuario) => __awaiter(this, void 0, void 0, function* () {
            // const usuarioSalvo = this.repository.save({ ...usuario });
            return new UsuarioEntity_1.default();
        });
