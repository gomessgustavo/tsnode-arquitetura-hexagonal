...
let DeletarProdutoService = class DeletarProdutoService {
    constructor(deletarProdutoPort) {
...
DeletarProdutoService = __decorate([
    tsyringe_1.injectable(),
    __param(0, tsyringe_1.inject("DeletarProdutoAdapter")),
